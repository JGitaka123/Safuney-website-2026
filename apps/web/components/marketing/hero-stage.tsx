...
/**
 * The hero's right-hand side: five packs off Safuney's own shelf on a white stage, with the two facts
 * that sell a concentrate — how far a drum goes, and how fast a price comes back.
 *
...
export function HeroStage() {
  return (
    <div className="relative mx-auto w-full max-w-[36rem]">
      ...
      {/* The two facts. Real text, so they are read, not described. */}
      ...
      <div className="absolute -bottom-5 right-3 flex max-w-[16rem] items-start gap-3 rounded-card bg-surface p-4 text-ink shadow-lift md:-right-6">
